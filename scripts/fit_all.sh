...
sbatch --array=0-19 scripts/fit.sh --no_diagnostics --name model_visual --features configs/features_model_visual.yaml --params configs/params_model_visual.yaml --output_dir $OUTPUTS_DIR
sbatch --array=0-19 scripts/fit.sh --no_diagnostics --name model_default --features configs/features_model_default.yaml --params configs/params_model_default.yaml --output_dir $OUTPUTS_DIR
