...
mapping = {
    ...
    # thinker – tap ∼30 %, 60 %, 90 % depth
    "thinker_08": model.model.layers[7].post_attention_layernorm,   # 0-based idx 7
    "thinker_17": model.model.layers[16].post_attention_layernorm,  # 0-based idx 16
    "thinker_25": model.model.layers[24].post_attention_layernorm,  # 0-based idx 24
}
...
if __name__ == "__main__":
    ...
    parser.add_argument(
        "--output_folder",
        type=str,
        default="/u/shdixit/MultimodalBrainModel/Features/Omni/Qwen2.5_7B/features",
